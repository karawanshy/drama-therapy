 ...
 * Displays a hero section with title, optional subtitle, and background image
 */
const PageHeader = ({
  title,
  subtitle,
  ...
  return <header className="relative min-h-[60vh] flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="container mx-auto px-4 z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {subtitle && <p className="text-xl md:text-2xl text-muted-foreground animate-fade-in-up [animation-delay:200ms] opacity-0 [animation-fill-mode:forwards]">
              {subtitle}
            </p>}
        </div>
      </div>
