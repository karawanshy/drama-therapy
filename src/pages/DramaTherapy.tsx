      ...
      <main className="pt-32 pb-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <Card className="shadow-large mb-12 animate-fade-in">
              <CardContent className="p-8 md:p-12">
                <blockquote className="text-2xl md:text-3xl font-lora italic text-primary mb-8 text-center border-l-4 border-primary pl-6">
