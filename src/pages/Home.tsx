...
const Home = () => {
  ...
  return <div className="min-h-screen">
      ...
      <section className="relative min-h-screen overflow-hidden pt-20 items-end justify-center flex flex-row bg-muted">
      ...
      <section className="py-20 md:py-32 bg-gradient-to-br from-primary to-primary/80">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center text-white fade-in-up">
            ...
            <Button asChild variant="glass-white" size="lg" className="font-semibold text-lg px-10 py-7 shadow-xl hover:shadow-2xl hover:scale-105">
              <Link to="/contact">
